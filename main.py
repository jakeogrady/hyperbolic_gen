...
def plotly_planes_with_dynamic_green_lines():
    ...
    fig.add_trace(
        go.Surface(x=Xg, y=Yg, z=Z1, colorscale="Blues", opacity=0.7, name="Π")
    )
    fig.add_trace(
        go.Surface(x=Xg, y=Yg, z=Z2, colorscale="Reds", opacity=0.7, name="Π₀")
    )
    ...
    for angle in angles:
        ...
        mesh_plane = go.Mesh3d(
            x=X_y, y=Y_y, z=Z_y, color="yellow", opacity=0.5, i=[0], j=[1], k=[2]
        )
        ...
        frames.append(
            go.Frame(
                ...
                data=[
                    go.Surface(
                        x=X1_rot, y=Y1_rot, z=Z1_rot, showscale=False, opacity=0.7
                    ),
                    go.Surface(
                        x=X2_rot, y=Y2_rot, z=Z2_rot, showscale=False, opacity=0.7
                    ),
                    go.Scatter3d(
                        x=[O[0]],
                        y=[O[1]],
